import roboticsImg from '../assets/Autonomous_Warehouse_Fleet.jpg'

import surgeryImg from '../assets/Surgical_Microrobots.jpg'
...
export const futureTechSections = [
  {
    ...
    title: 'Robotics',
    cards: [
      { title: 'Autonomous Warehouse Fleet', description: 'Swarm robots improve logistics throughput and accuracy.', image: roboticsImg },
